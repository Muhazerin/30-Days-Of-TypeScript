// 1
let challenge: string = "30 Days Of TypeScript";
...
// 6
let firstWord: string = challenge.substring(3, 7);
console.log(`6. Challenge first word: ${firstWord}`)

// 7
let challengeNoNum: string = challenge.slice(3);
console.log(`7. Challenge only words: ${challengeNoNum}`)

// 8
let containsScript: boolean = challenge.includes('Script')
console.log(`8. Challenge contains Script: ${containsScript}`)

// 9
// let challengeArray: Array<string> = challenge.split();
let challengeArray: Array<string> = [challenge]
console.log(`9. Challenge Array: ${challengeArray}`)

// 10
let challengeArray2: Array<string> = challenge.split(" ")
console.log(`10. Challenge Array 2: ${challengeArray2}`)

// 11
let companies: string = 'Facebook, Google, Microsoft, Apple, IBM, Oracle, Amazon' 
let companiesArrays: Array<string> = companies.split(",")
console.log(`11. Companies Array: ${companiesArrays}`)

// 12
let newChallenge: string = challenge.replace("TypeScript", "Python")
...
// 14
let challengeIndex: number = challenge.indexOf("T")
...
// 17
let sentence: string = 'You cannot end a sentence with because because because is a conjunction'
...
// 20
let trailingSentence: string = ' 30 Days Of JavaScript '
...
// 24
let sentence1: string = "30 Days of"
let sentence2: string = "TypeScript"
